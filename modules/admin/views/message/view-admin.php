        ...
        <div class="col-sm-6 col-lg-4 conversation-list-menu">
            ...
            <div id="conversation-list-menu">
                ...
                <div class="containerAdminMainConversation">
                    ...
                    <div class="container-user_messages active-message" id="adminMainConversation-<?= $conversationAdminMain->id;?>">
                    ...
                    <?php if ($expertConversations) : ?>
                        ...
                        <?php foreach ($expertConversations as $conversation) : ?>
                            ...
                            <div class="container-user_messages" id="expertConversation-<?= $conversation->id;?>">
                                ...
                                <?php if ($conversation->expert->getCountUnreadMessagesExpertFromUser($conversation->expert->id)) : ?>
                                    <div class="countUnreadMessagesSender active"><?= $conversation->expert->getCountUnreadMessagesExpertFromUser($conversation->expert->id); ?></div>
                                <?php else : ?>
                                    <div class="countUnreadMessagesSender"></div>
                                <?php endif; ?>
                    ...
                    <div class="data-chat" id="data-chat">
                        ...
                        <?php foreach ($messages as $i => $message) : ?>
                            ...
                            <?php if ($message->sender_id != $admin->id) : ?>
                                ...
                                <?php if ($message->status == MessageMainAdmin::NO_READ_MESSAGE) : ?>
