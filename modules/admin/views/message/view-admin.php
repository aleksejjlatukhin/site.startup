...
?>
    ...
    <div class="row">
        ...
        <div class="col-md-8" style="border-right: 1px solid #ccc; padding-right: 0;">
            ...
            <div class="data-message">
                ...
                <span style="float: left; padding-top: 5px;">
                    ...
                    <?= Html::img([$main_admin['avatar_image']],['width' => '40px', 'height' => '40px', 'class' => 'round-avatar'])?>
                </span>
        ...
        <div class="col-md-4">
            ...
            <p style=" font-weight: 700; color: green;padding-top: 20px;padding-left: 10px;">
                Главный администратор
            </p>

            <p style=" font-weight: 700;padding-left: 10px;">
                <?= Html::a('Проектанты', Url::to(['/admin/message/index', 'id' => $admin->id])) ?>
            </p>
