...
$this->title = 'Админка | Профиль | Сводная таблица проекта ' . '"' . mb_strtolower($model->project_name) . '"';
...
<div class="row">
    ...
    <div class="users-project col-md-9" style="padding-left: 0;">
        ...
        <table class="table table-bordered table">
            ...
            <tr>
                ...
                <th scope="col" rowspan="2" style="width: 100px; height: 60px; text-align: center;padding-bottom: 40px;">ГПС</th>
                <th scope="col" colspan="2" style="width: 120px; height: 30px; text-align: center;padding-bottom: 2px;">Проблема сегмента</th>
                <th scope="col" rowspan="2" style="width: 100px; height: 60px; text-align: center;padding-bottom: 40px;">ГЦП</th>
                <th scope="col" colspan="2" style="width: 120px; height: 30px; text-align: center;padding-bottom: 2px;">Ценностное предложение</th>
                <th scope="col" rowspan="2" style="width: 100px; height: 60px; text-align: center;padding-bottom: 40px;">ГMVP</th>
                <th scope="col" colspan="2" style="width: 120px; height: 30px; text-align: center;padding-bottom: 20px;">MVP (продукт)</th>
                <th scope="col" rowspan="2" style="width: 140px; height: 60px; text-align: center;padding-bottom: 30px;">Бизнес-модель</th>
            </tr>
            <tr>
                <td style="width: 50px;text-align: center;font-weight: 700;">Статус</td>
                <td style="width: 70px;text-align: center;font-weight: 700;">Дата</td>
                <td style="width: 50px;text-align: center;font-weight: 700;">Статус</td>
                <td style="width: 70px;text-align: center;font-weight: 700;">Дата</td>
                <td style="width: 50px;text-align: center;font-weight: 700;">Статус</td>
                <td style="width: 70px;text-align: center;font-weight: 700;">Дата</td>
