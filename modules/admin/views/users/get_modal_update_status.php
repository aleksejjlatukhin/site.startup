    ...
    <?php if ($model->status === User::STATUS_NOT_ACTIVE) : ?>
        ...
        <?php elseif ($model->id_admin !== null) : ?>
            ...
            <?php $form = ActiveForm::begin([
                'id' => 'formStatusUpdate',
                'action' => Url::to(['/admin/users/status-update', 'id' => $model->id]),
...
<?php elseif ($model->role === User::ROLE_MANAGER) : ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <?= $form->field($model, 'status', [
                    ...
                    'data' => [User::STATUS_ACTIVE => 'Активировать менеджера', User::STATUS_REMOVE => 'Удалить менеджера'],
                    'options' => ['id' => 'selectStatusUpdate'],
                    'disabled' => false,  //Сделать поле неактивным
                    'hideSearch' => true, //Скрытие поиска
                ]); ?>
