...
websocket.onmessage = function(response) {
    ...
    if (data.action === 'send-message') {
        ...
        if (data.sender === 'admin' && $(identifyingBlockSender).length)
...
$(body).on('input', 'textarea#input_send_message', function () {
    ...
    var url = '/admin/message/save-cache-message-main-admin-form?id=' + conversation_id;
...
$(body).on('click', '.pagination-messages .messages-pagination-list li.next a', function(e){
    ...
    var url = '/admin/message/get-page-message?id=' + conversation_id + '&page=' + next_page + '&final=' + idFirstMessagePreviosPage;
