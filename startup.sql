...
(17, 1, 'Сегмент 2', 'Краткое описание сегмента', 200, 'Предпринимательство', 'Поликлинические услуги', NULL, NULL, NULL, NULL, 8, 100, 10, 540, 'Краткое описание сегмента', 'Краткое описание сегмента', 'доп инфа', 1620512969, 1667745366, 1620655139, 1, '1'),
(26, 1, 'Сегмент 3', 'Краткое описание сегмента', 100, 'Образование', 'Репетиторство', 3, 4, 60, 50, 5000, 5000, 6, 7, NULL, NULL, '', 1620656418, 1640114892, 1620656543, 1, '1'),
(32, 1, 'Сегмент 4', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя Вид / специализация деятельности потребителя', 4, 5, 70, 50, 5000, 5000, 9, 5, NULL, NULL, '', 1621703242, 1665328815, 1623267598, 1, '1'),
(33, 1, 'Сегмент 5', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 6, 7, 5, 8, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1624393383, 1640109970, 1625001207, 1, '0'),
(34, 1, 'Сегмент 6', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 77, 88, 66, 1000000, 'Продукция / услуги предприятия', 'Партнеры предприятия', 'Дополнительная информация', 1633512488, 1640715427, 1640682103, 1, '1'),
(35, 1, 'Сегмент 7', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 7, 8, 70, 50, 5000, 5000, 9, 4, NULL, NULL, 'Дополнительная информация', 1640798226, 1666284470, 1666284470, 0, '1'),
(36, 1, 'Сегмент 8', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 8, 9, 7, 4, 'Продукция / услуги предприятия', 'Партнеры предприятия', 'Дополнительная информация', 1640798526, 1653128715, NULL, NULL, '1'),
(37, 6, 'Сегмент 1', 'Сегмент 1', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 22, 55, 70, 300, 5000, 50000, 200, 400, NULL, NULL, '', 1650457898, 1650458213, 1650458213, 1, '1'),
(38, 5, 'Сегмент 1', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 4, 56, 70, 50, 40000, 80000, 100, 15, NULL, NULL, '', 1652965736, 1652966588, 1652966588, 1, '1'),
(39, 5, 'Сегмент 2', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 10, 50, 20000, 999, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1652965800, 1655910375, 1655910375, 0, '1'),
(40, 5, 'Сегмент 3', 'Сегмент 3', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 40, 80, 70, 300, 60000, 90000, 20, 15, NULL, NULL, 'Дополнительная информация', 1653388328, 1655914599, NULL, NULL, '1'),
(41, 1, 'Сегмент 9', 'Сегмент 9', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 7, 99, 77, 496, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1655229264, 1669899789, 1669899789, 1, '1'),
(42, 1, 'Сегмент 15 (Наименование сегмента)', 'Сегмент 15', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 1, 2, 2, 1, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1665329293, 1666537054, NULL, NULL, '1'),
(52, 10, 'Наименование сегмента', 'Наименование сегмента', 100, 'Наименование сегмента', 'Наименование сегмента', 5, 6, 70, 50, 5000, 5000, 8, 8, NULL, NULL, '', 1666591705, 1666594063, 1666594063, 0, '1'),
(53, 10, 'Сегмент 2', 'Сегмент 2', 100, 'Сегмент 2', 'Сегмент 2', 78, 78, 50, 50, 5000, 5000, 9, 9, NULL, NULL, '', 1666594112, 1666594689, 1666594689, 1, '1'),
(54, 10, 'Сегмент 3', 'Сегмент 3', 100, 'Сегмент 3', 'Сегмент 3', 4, 5, 70, 50, 5000, 5000, 9, 9, NULL, NULL, '', 1666594825, 1666594884, 1666594884, 1, '1'),
(55, 1, 'сегмент 16', 'сегмент 16', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 56, 78, 70, 50, 65, 667, 4500, 19, NULL, NULL, '', 1669534774, 1670248700, NULL, NULL, '1');
...
(1, 'ivanov@mail.com', 'IvanoV', '$2y$13$GHlJeyDLCETcXCeFH5URZu/MCljd/xdr9DUQsAE.KBnAI.BC0tdva', 'tBH4LLXzmH4.jpg', 'avatar_xzGGOPyw_min.png', '32hRL8j7MkkANX9mIy7vYPhsxBuO5JD8', NULL, 10, 10, 20, 46, 1582408272, 1670329705),
...
(45, 'site.startup@mail.ru', 'trackerCompany', '$2y$13$D6BE4IjTaBex6YdJIG4ONuMRg87JIDmMxfMgdRzEv6.kVxks65Gu6', '', '', 'ncFQbSLBMGN5s7u_d_N4CtAdB3wOxnbI', NULL, 20, 10, 20, NULL, 1647771763, 1650531575),
