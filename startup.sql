...
(8, 17, 10, 54, 39, 25, 23, 'Взаимоотношения с клиентами', 'Ключевые партнеры', 'Каналы коммуникации и сбыта', 'Ключевые ресурсы', 'Структура издержек', 'Потоки поступления доходов', 1666596519, 1666596519, '0'),
(9, 18, 1, 41, 41, 26, 24, 'Масс медиа', 'Малый бизнес!', 'опт и розница', 'Кредиты', 'какие-то налоги, зарплата и закупка', 'продажи!', 1670168705, 1670234679, '1');
...
(19, 2, 3, 2, 'Какую потребность потребителя сегмента проверяем', '0'),
(20, 32, 1, 1, 'Какую потребность потребителя сегмента проверяем', '1'),
(21, 33, 2, 2, 'Какую потребность потребителя сегмента проверяем', '1'),
(22, 34, 2, 1, 'Какую потребность потребителя сегмента проверяем', '0'),
(23, 35, 2, 2, 'Какую потребность потребителя сегмента проверяем', '0'),
(24, 36, 2, 2, 'Какую потребность потребителя сегмента проверяем', '0'),
(25, 37, 4, 3, 'Какую потребность потребителя сегмента проверяем', '0'),
(26, 39, 1, 1, 'Какую потребность потребителя сегмента проверяем', '1'),
(27, 41, 3, 2, 'какая-то потребность', '1');
...
(20, 35, 1, 1, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '1'),
...
(23, 39, 2, 1, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '1'),
(24, 36, 2, 2, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '0'),
(25, 41, 3, 2, 'Приветствие в начале встречи!!!', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '1'),
(26, 52, 1, 1, 'Приветствие в начале встречи', 'Приветствие в начале встречи', 'Приветствие в начале встречи', '1'),
(27, 53, 1, 1, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '1'),
(28, 54, 1, 1, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '1'),
(29, 42, 2, 2, 'fgbfgb', 'fcgnfg', 'fgnxfg', '0'),
(30, 56, 2, 1, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '0');
...
(1, 1, 6, 1675595333, NULL),
(2, 6, 1, 1675595333, NULL),
...
(86, 333, 37, 28, 46, 'С проекта «<a href=\"/projects/index?id=1\">Перспективы города</a>» (проектант: <a href=\"/profile?id=1\">IvanoV</a>) отозван эксперт expertov.', 3579, 1658658782, 1658658782),
...
(88, 333, 38, 28, 46, 'На проект «<a href=\"/projects/index?id=1\">Проект 1</a>» (проектант: <a href=\"/profile?id=1\">IvanoV</a>) назначен эксперт SurikoV. Типы деятельности эксперта, по которым назначены экспертизы проекта: Ученый-эксперт в научной сфере, Разработчик-конструктор, Разработчик-программист.', 3579, 1658658899, 1658658899),
(89, 333, 39, 44, 47, 'С вашего проекта «Новый проект 1» отозван эксперт expertCompany.', 3579, 1659555050, 1659555050),
(90, 333, 39, 44, 45, 'С проекта «<a href=\"/projects/index?id=47\">Новый проект 1</a>» (проектант: <a href=\"/profile?id=47\">SimpleUserCompany</a>) отозван эксперт expertCompany.', 3579, 1659555050, 1659555050),
...
(92, 333, 43, 28, 46, 'На проект «<a href=\"/projects/index?id=1\">Проект 3</a>» (проектант: <a href=\"/profile?id=1\">IvanoV</a>) назначен эксперт expertov. Типы деятельности эксперта, по которым назначены экспертизы проекта: Отраслевой специалист по маркетингу, Специалист по регистрации ИС, Спецалист по коммуникациям.', 3579, 1661023886, 1661023886);
...
(12, 15, 1, 32, 17, 'ГЦП 1', 'Наш продукт продукт 1 помогает сегмент 4, который хочет удовлетворить проблему описание гипотезы проблемы 3, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 5.', 1624563764, 1, 1624476738, 1666553450, '0'),
...
(23, 21, 5, 38, 33, 'ГЦП 2', 'Наш продукт продукт 3 помогает сегмент 1, который хочет удовлетворить проблему описание гипотезы проблемы 1, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 4.', NULL, NULL, 1652968524, 1660478606, '1'),
(24, 1, 1, 16, 1, 'ГЦП 5', 'Наш продукт продукт 1 помогает сегмент 1, который хочет удовлетворить проблему инициативная группа нижегородцев на щелоковском хуторе записала видеообращение к президенту россии владимиру путину с просьбой отменить qr-коды. опубликовано в instagram-аккаунте блогера инициативная группа нижегородцев на щелоковском хуторе записала видеообращение к президенту россии владимиру путину с просьбой отменить qr-коды. опубликовано в instagram-аккаунте блогера, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 2.', NULL, NULL, 1665919650, 1665919653, '1'),
(25, 26, 10, 54, 39, 'ГЦП 1', 'Наш продукт продукт 6 помогает сегмент 3, который хочет удовлетворить проблему описание гипотезы проблемы 1, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 8.', 1666596444, 1, 1666596402, 1666596444, '1'),
(26, 27, 1, 41, 41, 'ГЦП 1', 'Наш продукт продукт 1 помогает сегмент 9, который хочет удовлетворить проблему отсутствие необходимой информации по патентованию продукта, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 3.', 1670153591, 1, 1670070639, 1670153591, '1'),
(30, 27, 1, 41, 41, 'ГЦП 2', 'Наш продукт продукт 5 помогает сегмент 9, который хочет удовлетворить проблему отсутствие необходимой информации по патентованию продукта, избавиться от проблемы(или снизить её) и позволяет получить выгоду в виде, выгода, в отличии от продукт 8.', NULL, NULL, 1670073403, 1670136435, '1');
...
(20, 17, 5, 38, 33, 22, 'MVP 2', 'Описание минимально жизнеспособного продукта 2', NULL, NULL, 1652968908, 1660479736, '1'),
(21, 14, 1, 16, 1, 17, 'MVP 2', 'Описание минимально жизнеспособного продукта 2', NULL, NULL, 1656149853, 1656149856, '1'),
(22, 1, 1, 16, 1, 1, 'MVP 4', 'Описание минимально жизнеспособного продукта 4', 1666291583, 0, 1666291537, 1666291583, '1'),
(23, 19, 10, 54, 39, 25, 'MVP 1', 'Описание минимально жизнеспособного продукта', 1666596491, 1, 1666596452, 1666596491, '1'),
(24, 20, 1, 41, 41, 26, 'MVP 1', 'Описание продукта 11', 1670167489, 1, 1670155652, 1670167489, '1'),
(27, 20, 1, 41, 41, 26, 'MVP 2', 'продукт 22', NULL, NULL, 1670157526, 1670157526, '0');
...
(17, 17, 32, 1, 'ГПС 3', 'проблемы 3', 5, 1624388310, 1666549976, 1624473511, 1, '0'),
...
(34, 22, 38, 5, 'ГПС 2', 'Описание гипотезы проблемы 2', 20, 1652966776, 1653410835, NULL, NULL, '1'),
(35, 22, 38, 5, 'ГПС 3', 'Описание гипотезы проблемы сегмента 3', 20, 1657447091, 1657447095, NULL, NULL, '1'),
(36, 22, 38, 5, 'ГПС 4', 'Описание гипотезы проблемы сегмента 4', 5, 1657447281, 1657447284, NULL, NULL, '1'),
(37, 22, 38, 5, 'ГПС 5', 'Описание гипотезы проблемы сегмента 5', 5, 1657447386, 1657447390, NULL, NULL, '1'),
(38, 22, 38, 5, 'ГПС 6', 'Описание гипотезы проблемы сегмента', 5, 1660478062, 1660478067, NULL, NULL, '1'),
(39, 28, 54, 10, 'ГПС 1', 'Описание гипотезы проблемы 1', 5, 1666595881, 1666596381, 1666596381, 1, '1'),
(40, 1, 16, 1, 'ГПС 4', 'Описание гипотезы проблемы сегмента 4', 20, 1669537807, 1669537807, NULL, NULL, '0'),
(41, 25, 41, 1, 'ГПС 1', 'Отсутствие необходимой информации по патентованию продукта', 20, 1669965534, 1670067023, 1670067023, 1, '1'),
(46, 25, 41, 1, 'ГПС 3', 'см ич', 5, 1669975164, 1669975164, NULL, NULL, '0'),
(47, 25, 41, 1, 'ГПС 4', 'аптап', 5, 1669975509, 1669975509, NULL, NULL, '0');
...
(21, 37, 28, 200, 1, 1000, NULL, 20, 2222, 1649852909, 1658658899),
(22, 28, 31, 100, 5, 1000, 1, NULL, 1111, 1658654215, 1658655666),
(23, 28, 37, 100, 5, 1000, 1, NULL, 1111, 1658655455, 1658658918),
(24, 28, 37, 150, 5, 1000, NULL, NULL, 2222, 1658655499, 1658658917),
(25, 28, 31, 150, 5, 1000, NULL, NULL, 2222, 1658655503, 1658655668),
(26, 28, 31, 100, 5, 1000, 1, NULL, 2222, 1658655602, 1658655787),
(27, 31, 28, 200, 5, 1000, NULL, 26, 2222, 1658655787, 1658655865),
(28, 28, 31, 350, 5, 1000, NULL, 27, 2222, 1658655865, 1658655919),
(29, 28, 31, 100, 5, 1000, 1, NULL, 2222, 1658655894, 1658657770),
(33, 31, 28, 200, 5, 1000, NULL, 29, 2222, 1658657770, 1658658203),
(34, 28, 31, 100, 5, 1000, 1, NULL, 2222, 1658658406, 1658658507),
(35, 31, 28, 200, 5, 1000, NULL, 34, 2222, 1658658507, 1658658563),
(36, 28, 31, 300, 5, 1000, NULL, 35, 2222, 1658658563, 1658658628),
(37, 28, 31, 400, 5, 1000, NULL, 36, 2222, 1658658782, 1658658821),
(38, 28, 37, 300, 1, 1000, NULL, 21, 2222, 1658658899, 1658658922),
(39, 44, 48, 400, 6, 500, NULL, 18, 2222, 1659555050, 1659555050),
(40, 44, 48, 100, 6, 500, 1, NULL, 2222, 1659555061, 1659555061),
(41, 28, 31, 100, 7, 1000, 1, NULL, 2222, 1661023805, 1661023856),
(42, 31, 28, 200, 7, 1000, NULL, 41, 2222, 1661023856, 1661023886),
(43, 28, 31, 300, 7, 500, NULL, 42, 2222, 1661023886, 1661023886),
(44, 28, 31, 100, 2, 500, 1, NULL, 2222, 1670424056, 1670424056),
(45, 28, 37, 100, 2, 500, 1, NULL, 1111, 1670424081, 1670424109),
(46, 28, 37, 150, 2, 500, NULL, NULL, 2222, 1670424109, 1670424109);
...
(17, 1, 'Сегмент 2', 'Краткое описание сегмента', 200, 'Предпринимательство', 'Поликлинические услуги', NULL, NULL, NULL, NULL, 8, 100, 10, 540, 'Краткое описание сегмента', 'Краткое описание сегмента', 'доп инфа', 1620512969, 1667745366, 1620655139, 1, '1', '0'),
(26, 1, 'Сегмент 3', 'Краткое описание сегмента', 100, 'Образование', 'Репетиторство', 3, 4, 60, 50, 5000, 5000, 6, 7, NULL, NULL, '', 1620656418, 1640114892, 1620656543, 1, '1', '0'),
(32, 1, 'Сегмент 4', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя Вид / специализация деятельности потребителя', 4, 5, 70, 50, 5000, 5000, 9, 5, NULL, NULL, '', 1621703242, 1665328815, 1623267598, 1, '1', '0'),
(33, 1, 'Сегмент 5', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 6, 7, 5, 8, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1624393383, 1640109970, 1625001207, 1, '0', '0'),
(34, 1, 'Сегмент 6', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 77, 88, 66, 1000000, 'Продукция / услуги предприятия', 'Партнеры предприятия', 'Дополнительная информация', 1633512488, 1640715427, 1640682103, 1, '1', '0'),
(35, 1, 'Сегмент 7', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 7, 8, 70, 50, 5000, 5000, 9, 4, NULL, NULL, 'Дополнительная информация', 1640798226, 1666284470, 1666284470, 0, '1', '0'),
(36, 1, 'Сегмент 8', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 8, 9, 7, 4, 'Продукция / услуги предприятия', 'Партнеры предприятия', 'Дополнительная информация', 1640798526, 1653128715, NULL, NULL, '1', '0'),
(37, 6, 'Сегмент 1', 'Сегмент 1', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 22, 55, 70, 300, 5000, 50000, 200, 400, NULL, NULL, '', 1650457898, 1650458213, 1650458213, 1, '1', '0'),
(38, 5, 'Сегмент 1', 'Краткое описание сегмента', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 4, 56, 70, 50, 40000, 80000, 100, 15, NULL, NULL, '', 1652965736, 1652966588, 1652966588, 1, '1', '0'),
(39, 5, 'Сегмент 2', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 10, 50, 20000, 999, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1652965800, 1655910375, 1655910375, 0, '1', '0'),
(40, 5, 'Сегмент 3', 'Сегмент 3', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 40, 80, 70, 300, 60000, 90000, 20, 15, NULL, NULL, 'Дополнительная информация', 1653388328, 1655914599, NULL, NULL, '1', '0'),
(41, 1, 'Сегмент 9', 'Сегмент 9', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 7, 99, 77, 496, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1655229264, 1669899789, 1669899789, 1, '1', '0'),
(42, 1, 'Сегмент 15 (Наименование сегмента)', 'Сегмент 15', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 1, 2, 2, 1, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1665329293, 1666537054, NULL, NULL, '1', '0'),
(52, 10, 'Наименование сегмента', 'Наименование сегмента', 100, 'Наименование сегмента', 'Наименование сегмента', 5, 6, 70, 50, 5000, 5000, 8, 8, NULL, NULL, '', 1666591705, 1666594063, 1666594063, 0, '1', '0'),
(53, 10, 'Сегмент 2', 'Сегмент 2', 100, 'Сегмент 2', 'Сегмент 2', 78, 78, 50, 50, 5000, 5000, 9, 9, NULL, NULL, '', 1666594112, 1666594689, 1666594689, 1, '1', '0'),
