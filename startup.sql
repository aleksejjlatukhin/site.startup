...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 10 2022 г., 21:52
...
(20, 35, 4, 3, 'Приветствие в начале встречи', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '0'),
...
(25, 41, 2, 1, 'Приветствие в начале встречи!', 'Информация о вас для респондентов', 'Причина и тема (что побудило) для проведения исследования', '0');
...
(85, 333, 37, 28, 1, 'С вашего проекта «Перспективы города» отозван эксперт expertov.', 3579, 1658658782, 1658658782),
...
(87, 333, 38, 28, 1, 'На ваш проект «Проект 1» назначен эксперт SurikoV. Типы деятельности эксперта, по которым назначены экспертизы проекта: Ученый-эксперт в научной сфере, Разработчик-конструктор, Разработчик-программист. В сообщениях создана беседа с экспертом.', 3579, 1658658899, 1658658899),
...
(5, 1, 1629312867, 1657447424, 'Перспективы города', 'Перспективы города', 'Описание проекта', 'Цель проекта', 'Результат интеллектуальной деятельности', 'Номер патента', 1629234000, 'Наименование патента', 'Суть результата интеллектуальной деятельности', 'На какой технологии основан проект', 'Макет базовой технологии', '', NULL, '', '', NULL, NULL, NULL, '', '1'),
...
(62, 25, 'Чем вы занимаетесь в настоящее время?', 1, 1655232122, 1655232124),
...
(76, 25, 'Респондент 1', '', '', NULL, ''),
(77, 25, 'Респондент 2', '', '', NULL, ''),
(78, 20, 'Респондент 4', '', '', NULL, '');
...
(36, 1, 'Сегмент 8', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 8, 9, 6, 7, 4, 'Продукция / услуги предприятия', 'Партнеры предприятия', 'Дополнительная информация', 1640798526, 1653128715, NULL, NULL, '1'),
...
(39, 5, 'Сегмент 2', 'Краткое описание сегмента', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 10, 50, 1000, 20000, 999, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1652965800, 1655910375, 1655910375, 0, '1'),
(40, 5, 'Сегмент 3', 'Сегмент 3', 100, 'Сфера деятельности потребителя', 'Вид / специализация деятельности потребителя', 40, 80, 70, 300, 60000, 90000, 10, 20, 15, NULL, NULL, 'Дополнительная информация', 1653388328, 1655914599, NULL, NULL, '1'),
(41, 1, 'Сегмент 9', 'Сегмент 9', 200, 'Сфера деятельности предприятия', 'Вид / специализация деятельности предприятия', NULL, NULL, NULL, NULL, 7, 99, 4, 77, 496, 'Продукция / услуги предприятия', 'Партнеры предприятия', '', 1655229264, 1655229284, NULL, NULL, '1');
...
(1, 'ivanov@mail.com', 'IvanoV', '$2y$13$GHlJeyDLCETcXCeFH5URZu/MCljd/xdr9DUQsAE.KBnAI.BC0tdva', 'tBH4LLXzmH4.jpg', 'avatar_RclFbZlo_min.png', '32hRL8j7MkkANX9mIy7vYPhsxBuO5JD8', NULL, 10, 10, 20, 46, 1582408272, 1659546016),
...
(54, 'alatuhin1428@yandex.ru', 'PetrovProjectUser', '$2y$13$ETPYGt0E0ZZynyC1.vXeYO84zsAWtW5axX5685YwMLITu7fBfTQMG', '', '', 'rzhx5Fa67SVic1VZxkMw_cEP5BfZR_8t', NULL, 10, 1, 20, NULL, 1653224322, 1653224374);
