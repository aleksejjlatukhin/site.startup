...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 26 2020 г., 19:54
...
(1, 1, '2020-02-23', 'Материалы полученные во время интервью', 'Методика проведения процедур на аппарате Ормед.doc', 'Вывод', '1'),
(2, 2, '2020-02-23', 'Материалы полученные во время интервью', '051119_Дизайн_акселератора.xlsx', 'Вывод', '1'),
(3, 3, '2020-02-23', 'Материалы полученные во время интервью', '051119_Дизайн_акселератора.xlsx', 'Вывод', '1'),
(4, 4, '2020-02-24', 'Материалы полученные во время интервью', 'dogovor_gruppy 2020.doc', 'Вывод', '0');
...
(1, 1, 'Отзыв 1', 'Антонов Юрий Николаевич', 'Организация/Должность', '200220Описание этапов для 1 стр_3.docx', 'Комментарий', '2020-02-23'),
(2, 1, 'Отзыв 2', 'Тюрикова Ирина Борисовна', 'Организация/Должность', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23'),
(3, 1, 'Отзыв 3', 'Маркелова Ирина Юрьевна', 'Организация/Должность', 'Методика проведения процедур на аппарате Ормед.doc', 'Комментарий', '2020-02-23'),
(4, 1, 'Отзыв 4', 'Новиков Андрей Борисович', 'Организация/Должность', 'Tekh_RAJDER.doc', 'Комментарий', '2020-02-25');
...
(1, 1, 'Отзыв 1', 'Новиков Олег Владимирович', 'Организация / Должность', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23'),
(2, 1, 'Отзыв 2', 'Аленина Юлия Антоновна', 'Организация / Должность', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23');
...
INSERT INTO `feedback_expert_gcp` (`id`, `confirm_gcp_id`, `title`, `name`, `position`, `feedback_file`, `comment`, `date_feedback`) VALUES
(1, 1, 'Отзыв 1', 'Новиков Алексей Иванович', 'ННГУ им.Лобачевского / эсперт', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23'),
(2, 1, 'Отзыв 2', 'Архипов Николай Петрович', 'ННГУ им.Лобачевского / эсперт', 'песенки.doc', 'Комментарий', '2020-02-23');
...
(1, 1, 'Отзыв 1', 'Николаев Борис Николаевич', 'ННГУ / руководитель', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23'),
(2, 1, 'Отзыв 2', 'Никулин Игорь Борисович', 'ООО \"Главбух\"', '051119_Дизайн_акселератора.xlsx', 'Комментарий', '2020-02-23');
...
(2, 1, 'ГПС 2', 'Напишите описание гипотезы проблемы сегмента', '2020-02-23', NULL, NULL, NULL),
...
(3, 1, 'ГMVP 3', 'Видео', '2020-02-23', '2020-02-23 20:19:21', NULL, NULL, NULL),
...
(10, 1, 'Бизнес требования для сервиса Акселератор.docx'),
(11, 1, 'Tekh_RAJDER.doc'),
(12, 1, 'Методика проведения процедур на аппарате Ормед.doc'),
(13, 1, 'песенки.doc');
...
(1, 1, 'Сегмент 1', 'Сфера деятельности потребителя', 'Род деятельности потребителя', 34, 500000, 600000, 666333000, '', '2020-02-23', '2020-03-24', '2020-02-23', '2020-04-23', '2020-02-23', '2020-05-23', '2020-02-23', '2020-06-22', '2020-02-23', '2020-07-22', '2020-02-23', '2020-08-21', '2020-02-23'),
(2, 1, 'Сегмент 2', '', '', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 1, 'Сегмент 3', '', '', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'Иванов', 'Иван', 'Иванович', '+7(999)99-99-99', 'ivanov@mail.com', 'IvanoV', '$2y$13$AXM0v8mZAVuhZDJPLLJOWOMvwURNqrqDNRAAFF5p1eVmQdph2n7z6', '32hRL8j7MkkANX9mIy7vYPhsxBuO5JD8', NULL, 'user', 10, 1582408272, 1582408272),
