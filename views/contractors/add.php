...
<!--TODO: Здесь необходимо сделать пошаговое назначение исполнителя на проект:-->
<!--TODO: 1. Укажите проект на который будет назначен исполнитель и вид деятельности с которым он будет назначен -->
<!--TODO: 2. После указания проектов и вида деятельности вывести всех исполнителей данной организации с указанным видом деятельности, -->
<!--TODO: те которые уже назначены пометить что запрос отправлен, по остальным кнопку отправить запрос. -->
<!--TODO: Так же у всех должна быть возможность просмотра инфы по исполнителю. После отправки запроса создать коммуникацию по аналогии с экспертами. -->
<!--TODO: Создать страницу для проектанта с коммуникациями по проектам, сделать ссылку на странице /contractors/index -->
