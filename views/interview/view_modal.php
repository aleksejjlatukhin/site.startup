...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Сведения о респонденте' . Html::img('/images/icons/icon_report_next.png'), ['/interview/get-instruction-step-three'],[
...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Внесите результаты интервью' . Html::img('/images/icons/icon_report_next.png'), ['/interview/get-instruction-step-three'],[
        'class' => 'link_to_instruction_page_in_modal open_modal_instruction_page', 'title' => 'Инструкция']),
    'headerOptions' => ['class' => 'style_header_modal_form', 'style' => ['text-align' => 'center']]
]); ?>
...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Результаты интервью' . Html::img('/images/icons/icon_report_next.png'), ['/interview/get-instruction-step-three'],[
        'class' => 'link_to_instruction_page_in_modal open_modal_instruction_page', 'title' => 'Инструкция']),
    'headerOptions' => ['class' => 'style_header_modal_form', 'style' => ['text-align' => 'center']]
]); ?>
