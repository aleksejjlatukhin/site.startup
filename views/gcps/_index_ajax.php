                ...
                <div>
                    ...
                    <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                        ...
                        <?php elseif ($model->getEnableExpertise() == EnableExpertise::ON) : ?>
                            ...
                            <?= Html::a(Html::img('/images/icons/icon-enable-expertise-success.png', ['style' => ['width' => '35px', 'margin-right' => '95px']]),['/expertise/get-list', 'stage' => StageExpertise::getList()[StageExpertise::GCP], 'stageId' => $model->id], [
