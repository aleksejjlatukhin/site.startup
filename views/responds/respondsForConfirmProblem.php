        ...
        <div style="display:flex; align-items:center; padding: 0;">
            ...
            <?php if ($confirm->getEnableExpertise() == EnableExpertise::ON) : ?>
                ...
                <?php if (User::isUserExpert(Yii::$app->user->identity['username'])) : ?>
                    ...
                    <?= Html::a('Экспертиза',['/expertise/get-list', 'stage' => StageExpertise::getList()[StageExpertise::CONFIRM_PROBLEM], 'stageId' => $confirm->id], [
            ...
            <?php else : ?>
                ...
                <?php if ($confirm->hypothesis->exist_confirm == 1) : ?>
                    ...
                    <?= Html::a( 'Далее', ['/gcps/index', 'id' => $confirm->id],[
                        'style' => [
                            'display' => 'flex',
                            'align-items' => 'center',
                            'justify-content' => 'center',
