...
<div class="responds-gcp-index">
    ...
    <div class="table-respond-index-kartik">
                ...
                'value' => function ($model, $key, $index, $widget) {
                    ...
                    if (!empty($model->descInterview->updated_at)){
                        ...
                        return '<div class="text-center">' . Html::a(
                                ...
                                ['/responds-gcp/data-availability', 'id' => Yii::$app->request->get('id')],
                                ['onclick'=>
                                    "$.ajax({
        
                                        url: '".Url::to(['/responds-gcp/data-availability', 'id' => Yii::$app->request->get('id')])."',
                                        method: 'POST',
                                        cache: false,
        ...
        echo GridView::widget([
            ...
            'panel' => [
                ...
                'before' => '<div style="font-size: 30px; font-weight: 700; color: #F2F2F2;">' .
                    ...
                    Html::a('Программа подтверждения ГЦП', ['/confirm-gcp/view', 'id' => $confirmGcp->id], ['class' => 'btn btn-sm btn-default pull-left font-header-table',  'style' => [ 'margin' => '5px', 'font-weight' => '700']]) .
            ...
            'exportConfig' => [
                GridView::PDF => [
                    ...
                    'filename' => 'Таблица_«Информация_о_респондентах»(Подтверждение_'.$gcp_title.'&&'.$problem_title.'&&'.$segment_name.'&&'.$project_filename.')' ,
        ...
        $form = ActiveForm::begin([
            'id' => 'new_respond_form',
            'action' => "/responds-gcp/create?id=$confirmGcp->id",
        ]); ?>
            ...
            foreach ($models as $i => $model) :
                ...
                if (empty($model->descInterview)) :
                    ...
                    <div class="desc-interview-create-form">
                        ...
                        <?php $form = ActiveForm::begin([
                            'action' => "/desc-interview-gcp/create?id=$model->id",
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $form->field($createDescInterviewForms[$i], 'status')->label('По результатам анкеты сделайте вывод о ценностном предложении:')->dropDownList([ '0' => 'Предложение не интересно', '1' => 'Предложение привлекательно', ]) ?>
                ...
                <div class="desc-interview-update-form">
                    ...
                    <?php if ($model->descInterview) : ?>
                        ...
                        <?php $form = ActiveForm::begin([
                            'action' => "/desc-interview-gcp/update?id=".$model->descInterview->id ,
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $form->field($updateDescInterviewForms[$i], 'status')->label('По результатам анкеты сделайте вывод о ценностном предложении:')->dropDownList([ '0' => 'Предложение не интересно', '1' => 'Предложение привлекательно', ]) ?>
                ...
                Modal::begin([
                    ...
                    'footer' => '<div class="text-center">'.
                        ...
                        Html::a('Ок', ['/responds-gcp/delete-respond', 'id' =>$model->id],[
                            'class' => 'btn btn-default',
                            'style' => ['width' => '120px'],
