...
<div class="segments-index">
    ...
    <div class="methodological-guide">
        ...
        <h3 class="header-text" id="generating_hypotheses_for_target_segments"><span>Генерация гипотез целевых сегментов</span></h3>

        <div class="row container-fluid">
            <div class="col-md-12">
                <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                    <?=  Html::a( '<div class="new_hypothesis_link_block"><div>' . Html::img(['@web/images/icons/add_vector.png'], ['style' => ['width' => '35px']]) . '</div><div style="padding-left: 20px;">Добавить сегмент</div></div>', ['/segment/get-hypothesis-to-create', 'id' => $project->id],
