...
<div class="confirm-gcp-view">
    ...
    <div id="step_three" class="tabcontent row">
        ...
        <div class="modal-windows">
            ...
            $form = ActiveForm::begin([
                'id' => 'new_respond_form',
                'action' => "/responds-gcp/create?id=$model->id",
                'options' => ['class' => 'g-py-15'],
                'errorCssClass' => 'u-has-error-v1',
                'successCssClass' => 'u-has-success-v1-1',
            ]); ?>
                    ...
                    <div class="respond-form">
                        ...
                        <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) :?>
                            ...
                            <?php $form = ActiveForm::begin([
                                'action' => "/responds-gcp/update?id=$respond->id",
                    ...
                    <div class="desc-interview-create-form">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                ])->label('По результатам опроса сделайте вывод о текущем ценностном предложении')->widget(Select2::class, [
                                    'data' => $selection_list,
                                    'options' => [
                ...
                <?php endif; ?>
                    ...
                    <div class="desc-interview-update-form">
                        ...
                        <?php if ($respond->descInterview) : ?>
                            ...
                            <?php if (User::isUserSimple(Yii::$app->user->identity['username'])) : ?>
                                ...
                                <?php $form = ActiveForm::begin([
                                    'action' => "/desc-interview-gcp/update?id=".$respond->descInterview->id ,
                            ...
                            <?php else : ?>
                                ...
                                <div class="row" style="margin-bottom: 15px; color: #4F4F4F;">
                                    ...
                                    <div class="col-md-12" style="padding: 0 20px; margin-bottom: 15px;">
                                        <div style="font-weight: 700;">По результатам опроса сделайте вывод о текущем ценностном предложении</div>
                                        <div>
                                            <?php
                    ...
                    Modal::begin([
                        ...
                        'footer' => '<div class="text-center">'.
                            ...
                            Html::a('Ок', ['/responds-gcp/delete', 'id' => $respond->id],[
                                'class' => 'btn btn-default',
                                'style' => ['width' => '120px'],
        ...
        <div class="container-fluid container-data">
            ...
            <div class="col-md-12" style="color: #4F4F4F; font-size: 16px; display: flex; justify-content: space-between; padding: 10px 20px; border-radius: 12px; border: 2px solid #707F99; align-items: center; margin-top: 30px;">
                ...
                <div class="" style="padding: 0;">
                    ...
                    Подтверждают ЦП: <?= $model->dataMembersOfGcp;?>
                </div>

                <div class="" style="padding: 0;">
                    <?= Html::img('@web/images/icons/danger-offer.png', ['style' => ['width' => '20px',]]);?>
                    Не подтверждают ЦП: <?= ($model->dataDescInterviewsOfModel - $model->dataMembersOfGcp);?>
                </div>
                ...
                <div class="" style="padding: 0;">
                    ...
                    if ($model->buttonMovingNextStage === true) :
                        ...
                        <?= Html::a( 'Далее', ['/confirm-gcp/moving-next-stage', 'id' => $model->id],[
                        'style' => [
                            'display' => 'flex',
                            'align-items' => 'center',
                            'justify-content' => 'center',
    ...
    <h4 class="text-center" style="color: #F2F2F2; padding: 0 30px;">
        Общее количество респондентов не должно быть меньше необходимого количества респондентов подтверждающих ценностное предложение.
    </h4>
...
$script = "
    ...
    //Переход к разработке MVP по кнопке Далее
                ...
                if (!response['error']) {
                    ...
                    if (!response['not_completed_descInterviews']) {
                        ...
                        if (response['exist_confirm'] === 1) {
                            window.location.href = '/mvp/index?id=".$model->id."';
                        }
                        
                        if (response['exist_confirm'] === null) {
                            window.location.href = '/confirm-gcp/exist-confirm?id=".$model->id."';
                        }
