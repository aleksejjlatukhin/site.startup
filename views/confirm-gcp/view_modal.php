...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Сведения о респонденте' . Html::img('/images/icons/icon_report_next.png'), ['/confirm-gcp/get-instruction-step-three'],[
...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Внесите результаты интервью' . Html::img('/images/icons/icon_report_next.png'), ['/confirm-gcp/get-instruction-step-three'],[
        'class' => 'link_to_instruction_page_in_modal open_modal_instruction_page', 'title' => 'Инструкция']),
    'headerOptions' => ['class' => 'style_header_modal_form', 'style' => ['text-align' => 'center']]
]); ?>
...
Modal::begin([
    ...
    'size' => 'modal-lg',
    'header' => Html::a('Результаты интервью' . Html::img('/images/icons/icon_report_next.png'), ['/confirm-gcp/get-instruction-step-three'],[
        'class' => 'link_to_instruction_page_in_modal open_modal_instruction_page', 'title' => 'Инструкция']),
    'headerOptions' => ['class' => 'style_header_modal_form', 'style' => ['text-align' => 'center']]
]); ?>
...
Modal::begin([
    ...
    'footer' => '<div class="text-center">'.
        ...
        Html::a('Ок', ['/confirm-gcp/exist-confirm', 'id' => $model->id],[
            'class' => 'btn btn-default',
            'style' => ['width' => '120px'],
            'id' => 'exist-confirm',
        ]).
...
Modal::begin([
    ...
    'header' => Html::a('<div style="margin-top: -15px;">Ответы респондентов на вопросы интервью' . Html::img('/images/icons/icon_export.png', ['style' => ['width' => '22px', 'margin-left' => '10px', 'margin-bottom' => '10px']]) . '</div>', [
        '/confirm-gcp/mpdf-questions-and-answers', 'id' => $model->id], [
        'class' => 'export_link',
        'target' => '_blank',
        'title' => 'Скачать в pdf',
    ]),
