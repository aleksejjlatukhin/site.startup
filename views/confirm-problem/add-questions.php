...
<div class="confirm-problem-add-questions table-project-kartik">
    ...
    <div class="row d-inline p-2" style="background: #707F99; font-size: 26px; font-weight: 700; color: #F2F2F2; border-radius: 5px 5px 0 0; padding: 10px; margin: 0; padding-top: 20px; padding-bottom: 10px;/*height: 80px;*//*padding-top: 12px;padding-left: 20px;margin-top: 10px;*/">
        ...
        <div class="col-md-12 col-lg-6" style="padding: 0 20px; text-align: center;">
            ...
            <?php
            echo 'Программа подтверждения ' . $problem->title .
    ...
    <div class="row" style="display: none;">
        <div class="col-md-12 form-newQuestion" style="margin-top: 5px;">
            ...
            <? $form = ActiveForm::begin(['id' => 'addNewQuestion', 'action' => Url::to(['/confirm-problem/add-question', 'id' => $confirmProblem->id])]);?>
    ...
    <div class="row" style="display: none;">
        <div class="col-md-12 form-QuestionsOfGeneralList" style="margin-top: 5px;">
            ...
            <? $form = ActiveForm::begin(['id' => 'addNewQuestionOfGeneralList', 'action' => Url::to(['/confirm-problem/add-question', 'id' => $confirmProblem->id])]);?>
    ...
    Modal::begin([
        ...
        'size' => 'modal-md',
        'header' => '<h4 class="text-center" style="color: #F2F2F2; padding: 0 30px;">1. Сформулируйте собственный список вопросов для анкеты или отредактируйте список «по-умолчанию».</h4>',
    ]);
    ?>
