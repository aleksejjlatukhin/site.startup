...
class CommunicationPatterns extends ActiveRecord
{
    ...
    const COMMUNICATION_DEFAULT_APPOINTS_EXPERT_PROJECT = 'Вы назначены на экспертизу по проекту {{наименование проекта, ссылка на проект}} по типам деятельности: {{список типов деятельности эксперта}}.';
